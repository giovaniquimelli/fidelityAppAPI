...
/**
 * Copy from \Symfony\Component\Debug\Exception\FlattenException
 * FlattenException wraps a PHP Error or Exception to be able to serialize it.
 *
 * Basically, this class removes all objects from the trace.
 * @see \Symfony\Component\Debug\Exception\FlattenException
 * @author Fabien Potencier <fabien@symfony.com>
 */
class ApiFlattenException
{
    private $message;
    private $code;
    private $previous;
    ...
    public static function create(\Throwable $exception, $statusCode = null, array $headers = [])
    {
