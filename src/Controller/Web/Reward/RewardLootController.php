...
/**
 * Class RewardLootController
 * @Route(path="/api/web/reward/loot")
 */
class RewardLootController extends BaseController
{
    /**
    ...
    public function list(Request $request): JsonResponse
    {
        ...
        return (new RewardModel($data))->selectMany(RewardTypes::LOOT);
    }
