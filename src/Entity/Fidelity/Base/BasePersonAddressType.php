...
class BasePersonAddressType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_address_type-blamable"})
     */
     ...
     * @Groups({"read-person_address_type","read-person_address_type-min"})
     */
     ...
     * @Groups({"read-person_address_type-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_address_type-trash"})
     */
