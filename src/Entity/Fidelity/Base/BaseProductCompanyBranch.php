...
class BaseProductCompanyBranch extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-product_company_branch-blamable"})
     */
     ...
     * @Groups({"read-product_company_branch","read-product_company_branch-min"})
     */
     ...
     * @Groups({"read-product_company_branch-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-product_company_branch-trash"})
     */
