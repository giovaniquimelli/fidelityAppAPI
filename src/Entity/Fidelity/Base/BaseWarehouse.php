...
class BaseWarehouse extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-warehouse-blamable"})
     */
     ...
     * @Groups({"read-warehouse","read-warehouse-min"})
     */
     ...
     * @Groups({"read-warehouse-timestampable"})
     */
