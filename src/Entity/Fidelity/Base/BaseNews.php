...
class BaseNews extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-news-blamable"})
     */
     ...
     * @Groups({"read-news","read-news-min"})
     */
     ...
     * @Groups({"read-news-timestampable"})
     */
