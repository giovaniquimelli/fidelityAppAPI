...
class BaseEmployeeSalary extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-employee_salary-blamable"})
     */
     ...
     * @Groups({"read-employee_salary","read-employee_salary-min"})
     */
     ...
     * @Groups({"read-employee_salary-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-employee_salary-trash"})
     */
