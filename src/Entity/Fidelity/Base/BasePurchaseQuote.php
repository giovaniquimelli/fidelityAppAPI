...
class BasePurchaseQuote extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-purchase_quote-blamable"})
     */
     ...
     * @Groups({"read-purchase_quote","read-purchase_quote-min"})
     */
     ...
     * @Groups({"read-purchase_quote-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-purchase_quote-trash"})
     */
