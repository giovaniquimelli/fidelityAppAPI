...
class BaseTransactionRecord extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-transaction_record-blamable"})
     */
     ...
     * @Groups({"read-transaction_record","read-transaction_record-min"})
     */
     ...
     * @Groups({"read-transaction_record-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-transaction_record-trash"})
     */
