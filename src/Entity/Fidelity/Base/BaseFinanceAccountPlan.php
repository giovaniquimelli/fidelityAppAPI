...
class BaseFinanceAccountPlan extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_account_plan-blamable"})
     */
     ...
     * @Groups({"read-finance_account_plan","read-finance_account_plan-min"})
     */
     ...
     * @Groups({"read-finance_account_plan-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_account_plan-trash"})
     */
