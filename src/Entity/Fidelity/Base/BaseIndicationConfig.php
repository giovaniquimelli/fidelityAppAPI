...
class BaseIndicationConfig extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-indication_config-blamable"})
     */
     ...
     * @Groups({"read-indication_config-id"})
     */
     ...
     * @Groups({"read-indication_config-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-indication_config-trash"})
     */
