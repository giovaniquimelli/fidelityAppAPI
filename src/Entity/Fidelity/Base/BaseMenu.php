...
class BaseMenu extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-menu-blamable"})
     */
     ...
     * @Groups({"read-menu","read-menu-min"})
     */
     ...
     * @Groups({"read-menu-timestampable"})
     */
