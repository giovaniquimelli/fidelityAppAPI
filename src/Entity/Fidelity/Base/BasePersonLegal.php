...
class BasePersonLegal extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_legal-blamable"})
     */
     ...
     * @Groups({"read-person_legal","read-person_legal-min"})
     */
     ...
     * @Groups({"read-person_legal-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_legal-trash"})
     */
