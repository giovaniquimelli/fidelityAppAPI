...
class BaseCompanyBranch extends \App\Doctrine\BaseDefaultEntity
{
     ...
     *
     * @ORM\OneToMany(targetEntity="RewardCompanyBranch", mappedBy="companyBranch")
     */
    protected $rewardCompanyBranch;

    /**
     * @return Users|null
     * @Groups({"read-company_branch-blamable"})
     */
     ...
     * @Groups({"read-company_branch","read-company_branch-min"})
     */
     ...
     * @Groups({"read-company_branch-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-company_branch-trash"})
     */
