...
class BasePartner extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-partner-blamable"})
     */
     ...
     * @Groups({"read-partner-timestampable"})
     */
