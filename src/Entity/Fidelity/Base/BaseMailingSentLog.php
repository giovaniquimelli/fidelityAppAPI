...
class BaseMailingSentLog extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-mailing_sent_log-blamable"})
     */
     ...
     * @Groups({"read-mailing_sent_log","read-mailing_sent_log-min"})
     */
     ...
     * @Groups({"read-mailing_sent_log-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-mailing_sent_log-trash"})
     */
