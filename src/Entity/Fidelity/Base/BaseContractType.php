...
class BaseContractType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-contract_type-blamable"})
     */
     ...
     * @Groups({"read-contract_type","read-contract_type-min"})
     */
     ...
     * @Groups({"read-contract_type-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-contract_type-trash"})
     */
