...
class BaseConfigType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-config_type-blamable"})
     */
     ...
     * @Groups({"read-config_type","read-config_type-min"})
     */
     ...
     * @Groups({"read-config_type-timestampable"})
     */
