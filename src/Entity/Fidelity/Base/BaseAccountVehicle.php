...
class BaseAccountVehicle extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-account_vehicle-blamable"})
     */
     ...
     * @Groups({"read-account_vehicle","read-account_vehicle-min"})
     */
     ...
     * @Groups({"read-account_vehicle-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-account_vehicle-trash"})
     */
