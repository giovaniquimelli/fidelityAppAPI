...
class BaseFinanceCfop extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_cfop-blamable"})
     */
     ...
     * @Groups({"read-finance_cfop","read-finance_cfop-min"})
     */
     ...
     * @Groups({"read-finance_cfop-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_cfop-trash"})
     */
