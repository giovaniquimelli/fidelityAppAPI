...
class BaseMobileDevice extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-mobile_device-blamable"})
     */
     ...
     * @Groups({"read-mobile_device","read-mobile_device-min"})
     */
     ...
     * @Groups({"read-mobile_device-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-mobile_device-trash"})
     */
