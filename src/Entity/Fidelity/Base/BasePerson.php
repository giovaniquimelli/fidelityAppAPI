...
class BasePerson extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person-blamable"})
     */
     ...
     * @Groups({"read-person","read-person-min"})
     */
     ...
     * @Groups({"read-person-timestampable"})
     */
