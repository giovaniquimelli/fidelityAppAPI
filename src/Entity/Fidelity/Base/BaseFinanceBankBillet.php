...
class BaseFinanceBankBillet extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_bank_billet-blamable"})
     */
     ...
     * @Groups({"read-finance_bank_billet","read-finance_bank_billet-min"})
     */
     ...
     * @Groups({"read-finance_bank_billet-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_bank_billet-trash"})
     */
