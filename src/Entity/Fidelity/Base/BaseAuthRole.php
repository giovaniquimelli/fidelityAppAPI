...
class BaseAuthRole extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-auth_role-blamable"})
     */
     ...
     * @Groups({"read-auth_role","read-auth_role-min"})
     */
     ...
     * @Groups({"read-auth_role-timestampable"})
     */
