...
class BasePaymentType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-payment_type-blamable"})
     */
     ...
     * @Groups({"read-payment_type","read-payment_type-min"})
     */
     ...
     * @Groups({"read-payment_type-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-payment_type-trash"})
     */
