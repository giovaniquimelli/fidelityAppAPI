...
class BasePoll extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-poll-blamable"})
     */
     ...
     * @Groups({"read-poll","read-poll-min"})
     */
     ...
     * @Groups({"read-poll-timestampable"})
     */
