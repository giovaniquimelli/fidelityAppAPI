...
class BaseFinanceBankAccount extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_bank_account-blamable"})
     */
     ...
     * @Groups({"read-finance_bank_account","read-finance_bank_account-min"})
     */
     ...
     * @Groups({"read-finance_bank_account-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_bank_account-trash"})
     */
