...
class BaseFinanceAccountType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_account_type-blamable"})
     */
     ...
     * @Groups({"read-finance_account_type","read-finance_account_type-min"})
     */
     ...
     * @Groups({"read-finance_account_type-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_account_type-trash"})
     */
