...
class BaseConfigRefConfigList extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-config_ref_config_list-blamable"})
     */
     ...
     * @Groups({"read-config_ref_config_list","read-config_ref_config_list-min"})
     */
     ...
     * @Groups({"read-config_ref_config_list-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-config_ref_config_list-trash"})
     */
