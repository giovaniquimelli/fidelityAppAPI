...
class BaseAuthPermission extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-auth_permission-blamable"})
     */
     ...
     * @Groups({"read-auth_permission","read-auth_permission-min"})
     */
     ...
     * @Groups({"read-auth_permission-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-auth_permission-trash"})
     */
