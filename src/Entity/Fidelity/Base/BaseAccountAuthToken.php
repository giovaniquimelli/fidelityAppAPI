...
class BaseAccountAuthToken extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-account_auth_token-blamable"})
     */
     ...
     * @Groups({"read-account_auth_token","read-account_auth_token-min"})
     */
     ...
     * @Groups({"read-account_auth_token-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-account_auth_token-trash"})
     */
