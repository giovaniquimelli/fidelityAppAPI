...
class BaseUsersRememberToken extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-users_remember_token-blamable"})
     */
     ...
     * @Groups({"read-users_remember_token","read-users_remember_token-min"})
     */
     ...
     * @Groups({"read-users_remember_token-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-users_remember_token-trash"})
     */
