...
class BasePersonMail extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_mail-blamable"})
     */
     ...
     * @Groups({"read-person_mail","read-person_mail-min"})
     */
     ...
     * @Groups({"read-person_mail-timestampable"})
     */
