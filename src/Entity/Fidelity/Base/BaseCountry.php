...
class BaseCountry extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-country-blamable"})
     */
     ...
     * @Groups({"read-country","read-country-min"})
     */
     ...
     * @Groups({"read-country-timestampable"})
     */
