...
class BasePersonIndividual extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_individual-blamable"})
     */
     ...
     * @Groups({"read-person_individual","read-person_individual-min"})
     */
     ...
     * @Groups({"read-person_individual-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_individual-trash"})
     */
