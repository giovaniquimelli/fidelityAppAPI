...
class BaseCompanyBranchImage extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-company_branch_image-blamable"})
     */
     ...
     * @Groups({"read-company_branch_image","read-company_branch_image-min"})
     */
     ...
     * @Groups({"read-company_branch_image-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-company_branch_image-trash"})
     */
