...
class BaseFinanceBilling extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_billing-blamable"})
     */
     ...
     * @Groups({"read-finance_billing","read-finance_billing-min"})
     */
     ...
     * @Groups({"read-finance_billing-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_billing-trash"})
     */
