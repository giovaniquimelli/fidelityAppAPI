...
class BaseEquipment extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-equipment-blamable"})
     */
     ...
     * @Groups({"read-equipment","read-equipment-min"})
     */
     ...
     * @Groups({"read-equipment-timestampable"})
     */
