...
class BaseMailingConfig extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-mailing_config-blamable"})
     */
     ...
     * @Groups({"read-mailing_config","read-mailing_config-min"})
     */
     ...
     * @Groups({"read-mailing_config-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-mailing_config-trash"})
     */
