...
class BaseEquipmentType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-equipment_type-blamable"})
     */
     ...
     * @Groups({"read-equipment_type","read-equipment_type-min"})
     */
     ...
     * @Groups({"read-equipment_type-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-equipment_type-trash"})
     */
