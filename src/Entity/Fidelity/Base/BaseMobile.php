...
class BaseMobile extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-mobile-blamable"})
     */
     ...
     * @Groups({"read-mobile","read-mobile-min"})
     */
     ...
     * @Groups({"read-mobile-timestampable"})
     */
