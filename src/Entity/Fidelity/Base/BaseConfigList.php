...
class BaseConfigList extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-config_list-blamable"})
     */
     ...
     * @Groups({"read-config_list","read-config_list-min"})
     */
     ...
     * @Groups({"read-config_list-timestampable"})
     */
