...
class BaseAccount extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-account-blamable"})
     */
     ...
     * @Groups({"read-account","read-account-min"})
     */
     ...
     * @Groups({"read-account-timestampable"})
     */
