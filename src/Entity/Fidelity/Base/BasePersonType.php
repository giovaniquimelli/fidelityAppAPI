...
class BasePersonType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_type-blamable"})
     */
     ...
     * @Groups({"read-person_type","read-person_type-min"})
     */
     ...
     * @Groups({"read-person_type-timestampable"})
     */
