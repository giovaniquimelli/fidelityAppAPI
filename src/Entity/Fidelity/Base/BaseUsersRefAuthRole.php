...
class BaseUsersRefAuthRole extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-users_ref_auth_role-blamable"})
     */
     ...
     * @Groups({"read-users_ref_auth_role","read-users_ref_auth_role-min"})
     */
     ...
     * @Groups({"read-users_ref_auth_role-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-users_ref_auth_role-trash"})
     */
