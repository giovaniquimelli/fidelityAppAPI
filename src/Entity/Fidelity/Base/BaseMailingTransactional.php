...
class BaseMailingTransactional extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-mailing_transactional-blamable"})
     */
     ...
     * @Groups({"read-mailing_transactional","read-mailing_transactional-min"})
     */
     ...
     * @Groups({"read-mailing_transactional-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-mailing_transactional-trash"})
     */
