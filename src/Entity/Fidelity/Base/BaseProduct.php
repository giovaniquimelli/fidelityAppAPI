...
class BaseProduct extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-product-blamable"})
     */
     ...
     * @Groups({"read-product","read-product-min"})
     */
     ...
     * @Groups({"read-product-timestampable"})
     */
