...
class BaseBank extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-bank-blamable"})
     */
     ...
     * @Groups({"read-bank","read-bank-min"})
     */
     ...
     * @Groups({"read-bank-timestampable"})
     */
