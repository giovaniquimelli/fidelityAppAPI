...
class BaseAccountCode extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-account_code-blamable"})
     */
     ...
     * @Groups({"read-account_code","read-account_code-min"})
     */
     ...
     * @Groups({"read-account_code-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-account_code-trash"})
     */
