...
class BaseContractModel extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-contract_model-blamable"})
     */
     ...
     * @Groups({"read-contract_model","read-contract_model-min"})
     */
     ...
     * @Groups({"read-contract_model-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-contract_model-trash"})
     */
