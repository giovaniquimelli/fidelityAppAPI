...
class BaseFinancePaymentType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_payment_type-blamable"})
     */
     ...
     * @Groups({"read-finance_payment_type","read-finance_payment_type-min"})
     */
     ...
     * @Groups({"read-finance_payment_type-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_payment_type-trash"})
     */
