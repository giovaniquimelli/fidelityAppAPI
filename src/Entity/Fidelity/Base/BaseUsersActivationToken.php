...
class BaseUsersActivationToken extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-users_activation_token-blamable"})
     */
     ...
     * @Groups({"read-users_activation_token","read-users_activation_token-min"})
     */
     ...
     * @Groups({"read-users_activation_token-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-users_activation_token-trash"})
     */
