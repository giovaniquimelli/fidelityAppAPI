...
class BaseEmployeeTimetable extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-employee_timetable-blamable"})
     */
     ...
     * @Groups({"read-employee_timetable","read-employee_timetable-min"})
     */
     ...
     * @Groups({"read-employee_timetable-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-employee_timetable-trash"})
     */
