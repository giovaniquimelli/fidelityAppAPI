...
class BaseMailing extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-mailing-blamable"})
     */
     ...
     * @Groups({"read-mailing","read-mailing-min"})
     */
     ...
     * @Groups({"read-mailing-timestampable"})
     */
