...
class BaseCity extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-city-blamable"})
     */
     ...
     * @Groups({"read-city","read-city-min"})
     */
     ...
     * @Groups({"read-city-timestampable"})
     */
