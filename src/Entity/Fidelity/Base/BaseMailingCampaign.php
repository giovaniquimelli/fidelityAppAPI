...
class BaseMailingCampaign extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-mailing_campaign-blamable"})
     */
     ...
     * @Groups({"read-mailing_campaign","read-mailing_campaign-min"})
     */
     ...
     * @Groups({"read-mailing_campaign-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-mailing_campaign-trash"})
     */
