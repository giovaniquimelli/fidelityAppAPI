...
class BasePersonFingerprint extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_fingerprint-blamable"})
     */
     ...
     * @Groups({"read-person_fingerprint","read-person_fingerprint-min"})
     */
     ...
     * @Groups({"read-person_fingerprint-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_fingerprint-trash"})
     */
