...
class BaseFinanceDeposit extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_deposit-blamable"})
     */
     ...
     * @Groups({"read-finance_deposit","read-finance_deposit-min"})
     */
     ...
     * @Groups({"read-finance_deposit-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_deposit-trash"})
     */
