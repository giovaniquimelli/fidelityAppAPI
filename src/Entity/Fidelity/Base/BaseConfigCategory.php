...
class BaseConfigCategory extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-config_category-blamable"})
     */
     ...
     * @Groups({"read-config_category","read-config_category-min"})
     */
     ...
     * @Groups({"read-config_category-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-config_category-trash"})
     */
