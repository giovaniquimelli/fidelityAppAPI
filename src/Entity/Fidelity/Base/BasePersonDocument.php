...
class BasePersonDocument extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_document-blamable"})
     */
     ...
     * @Groups({"read-person_document","read-person_document-min"})
     */
     ...
     * @Groups({"read-person_document-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_document-trash"})
     */
