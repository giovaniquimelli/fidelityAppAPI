...
class BaseConfig extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-config-blamable"})
     */
     ...
     * @Groups({"read-config","read-config-min"})
     */
     ...
     * @Groups({"read-config-timestampable"})
     */
