...
class BaseCompanyBranchGroup extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-company_branch_group-blamable"})
     */
     ...
     * @Groups({"read-company_branch_group","read-company_branch_group-min"})
     */
     ...
     * @Groups({"read-company_branch_group-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-company_branch_group-trash"})
     */
