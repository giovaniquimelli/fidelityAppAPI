...
class BaseSession extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-session-blamable"})
     */
     ...
     * @Groups({"read-session","read-session-min"})
     */
     ...
     * @Groups({"read-session-timestampable"})
     */
