...
class BaseMailingMailAccount extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-mailing_mail_account-blamable"})
     */
     ...
     * @Groups({"read-mailing_mail_account","read-mailing_mail_account-min"})
     */
     ...
     * @Groups({"read-mailing_mail_account-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-mailing_mail_account-trash"})
     */
