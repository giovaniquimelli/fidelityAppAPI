...
class BasePersonAccessCode extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_access_code-blamable"})
     */
     ...
     * @Groups({"read-person_access_code","read-person_access_code-min"})
     */
     ...
     * @Groups({"read-person_access_code-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_access_code-trash"})
     */
