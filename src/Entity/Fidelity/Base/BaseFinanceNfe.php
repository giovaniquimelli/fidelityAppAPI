...
class BaseFinanceNfe extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_nfe-blamable"})
     */
     ...
     * @Groups({"read-finance_nfe","read-finance_nfe-min"})
     */
     ...
     * @Groups({"read-finance_nfe-timestampable"})
     */
