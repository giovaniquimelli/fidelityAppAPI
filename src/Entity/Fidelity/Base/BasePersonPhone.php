...
class BasePersonPhone extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_phone-blamable"})
     */
     ...
     * @Groups({"read-person_phone","read-person_phone-min"})
     */
     ...
     * @Groups({"read-person_phone-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_phone-trash"})
     */
