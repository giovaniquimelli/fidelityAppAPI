...
class BaseFinanceCardPayment extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_card_payment-blamable"})
     */
     ...
     * @Groups({"read-finance_card_payment","read-finance_card_payment-min"})
     */
     ...
     * @Groups({"read-finance_card_payment-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_card_payment-trash"})
     */
