...
class BaseUsersAuthToken extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-users_auth_token-blamable"})
     */
     ...
     * @Groups({"read-users_auth_token","read-users_auth_token-min"})
     */
     ...
     * @Groups({"read-users_auth_token-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-users_auth_token-trash"})
     */
