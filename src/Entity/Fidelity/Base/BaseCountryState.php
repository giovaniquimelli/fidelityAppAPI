...
class BaseCountryState extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-country_state-blamable"})
     */
     ...
     * @Groups({"read-country_state","read-country_state-min"})
     */
     ...
     * @Groups({"read-country_state-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-country_state-trash"})
     */
