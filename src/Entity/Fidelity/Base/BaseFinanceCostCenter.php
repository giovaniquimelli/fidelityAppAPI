...
class BaseFinanceCostCenter extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_cost_center-blamable"})
     */
     ...
     * @Groups({"read-finance_cost_center","read-finance_cost_center-min"})
     */
     ...
     * @Groups({"read-finance_cost_center-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_cost_center-trash"})
     */
