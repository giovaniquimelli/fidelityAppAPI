...
class BasePersonAddress extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_address-blamable"})
     */
     ...
     * @Groups({"read-person_address","read-person_address-min"})
     */
     ...
     * @Groups({"read-person_address-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_address-trash"})
     */
