...
class BaseEmployee extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-employee-blamable"})
     */
     ...
     * @Groups({"read-employee","read-employee-min"})
     */
     ...
     * @Groups({"read-employee-timestampable"})
     */
