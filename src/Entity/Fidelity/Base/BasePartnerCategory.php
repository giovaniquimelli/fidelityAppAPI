...
class BasePartnerCategory extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-partner_category-blamable"})
     */
     ...
     * @Groups({"read-partner_category-id"})
     */
     ...
     * @Groups({"read-partner_category-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-partner_category-trash"})
     */
