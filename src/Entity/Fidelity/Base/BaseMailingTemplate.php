...
class BaseMailingTemplate extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-mailing_template-blamable"})
     */
     ...
     * @Groups({"read-mailing_template","read-mailing_template-min"})
     */
     ...
     * @Groups({"read-mailing_template-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-mailing_template-trash"})
     */
