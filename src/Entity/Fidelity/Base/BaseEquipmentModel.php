...
class BaseEquipmentModel extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-equipment_model-blamable"})
     */
     ...
     * @Groups({"read-equipment_model","read-equipment_model-min"})
     */
     ...
     * @Groups({"read-equipment_model-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-equipment_model-trash"})
     */
