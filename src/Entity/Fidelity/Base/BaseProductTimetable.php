...
class BaseProductTimetable extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-product_timetable-blamable"})
     */
     ...
     * @Groups({"read-product_timetable","read-product_timetable-min"})
     */
     ...
     * @Groups({"read-product_timetable-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-product_timetable-trash"})
     */
