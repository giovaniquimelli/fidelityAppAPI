...
class BaseIoAccessRecord extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-io_access_record-blamable"})
     */
     ...
     * @Groups({"read-io_access_record","read-io_access_record-min"})
     */
     ...
     * @Groups({"read-io_access_record-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-io_access_record-trash"})
     */
