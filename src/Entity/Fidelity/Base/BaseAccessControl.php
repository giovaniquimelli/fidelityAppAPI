...
class BaseAccessControl extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-access_control-blamable"})
     */
     ...
     * @Groups({"read-access_control","read-access_control-min"})
     */
     ...
     * @Groups({"read-access_control-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-access_control-trash"})
     */
