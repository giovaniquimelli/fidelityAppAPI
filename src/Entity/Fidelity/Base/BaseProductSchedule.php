...
class BaseProductSchedule extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-product_schedule-blamable"})
     */
     ...
     * @Groups({"read-product_schedule","read-product_schedule-min"})
     */
     ...
     * @Groups({"read-product_schedule-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-product_schedule-trash"})
     */
