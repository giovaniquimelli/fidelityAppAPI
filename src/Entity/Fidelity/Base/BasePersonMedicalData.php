...
class BasePersonMedicalData extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_medical_data-blamable"})
     */
     ...
     * @Groups({"read-person_medical_data","read-person_medical_data-min"})
     */
     ...
     * @Groups({"read-person_medical_data-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_medical_data-trash"})
     */
