...
class BaseFinanceCashFlow extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_cash_flow-blamable"})
     */
     ...
     * @Groups({"read-finance_cash_flow","read-finance_cash_flow-min"})
     */
     ...
     * @Groups({"read-finance_cash_flow-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_cash_flow-trash"})
     */
