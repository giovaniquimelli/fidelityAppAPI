...
class BaseEquipmentBrand extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-equipment_brand-blamable"})
     */
     ...
     * @Groups({"read-equipment_brand","read-equipment_brand-min"})
     */
     ...
     * @Groups({"read-equipment_brand-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-equipment_brand-trash"})
     */
