...
class BasePersonDocumentType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_document_type-blamable"})
     */
     ...
     * @Groups({"read-person_document_type","read-person_document_type-min"})
     */
     ...
     * @Groups({"read-person_document_type-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_document_type-trash"})
     */
