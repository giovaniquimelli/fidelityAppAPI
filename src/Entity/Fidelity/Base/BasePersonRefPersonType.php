...
class BasePersonRefPersonType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_ref_person_type-blamable"})
     */
     ...
     * @Groups({"read-person_ref_person_type","read-person_ref_person_type-min"})
     */
     ...
     * @Groups({"read-person_ref_person_type-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_ref_person_type-trash"})
     */
