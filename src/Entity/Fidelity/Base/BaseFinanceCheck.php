...
class BaseFinanceCheck extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-finance_check-blamable"})
     */
     ...
     * @Groups({"read-finance_check","read-finance_check-min"})
     */
     ...
     * @Groups({"read-finance_check-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-finance_check-trash"})
     */
