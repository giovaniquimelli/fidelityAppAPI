...
class BasePersonPhoneType extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-person_phone_type-blamable"})
     */
     ...
     * @Groups({"read-person_phone_type","read-person_phone_type-min"})
     */
     ...
     * @Groups({"read-person_phone_type-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-person_phone_type-trash"})
     */
