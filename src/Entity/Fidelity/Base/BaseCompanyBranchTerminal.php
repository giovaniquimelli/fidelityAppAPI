...
class BaseCompanyBranchTerminal extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-company_branch_terminal-blamable"})
     */
     ...
     * @Groups({"read-company_branch_terminal-id"})
     */
     ...
     * @Groups({"read-company_branch_terminal-timestampable"})
     */
    ...
    /**
     * @return DateTime|null
     * @Groups({"read-company_branch_terminal-trash"})
     */
