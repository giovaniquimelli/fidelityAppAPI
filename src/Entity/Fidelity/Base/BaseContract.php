...
class BaseContract extends \App\Doctrine\BaseDefaultEntity
{
    //#region DefaultEntity

    /**
     * @return Users|null
     * @Groups({"read-contract-blamable"})
     */
     ...
     * @Groups({"read-contract","read-contract-min"})
     */
     ...
     * @Groups({"read-contract-timestampable"})
     */
