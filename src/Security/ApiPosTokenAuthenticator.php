...
class ApiPosTokenAuthenticator extends AbstractGuardAuthenticator
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        $session = $rep->findOneByToken($credentials['api_key']);
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        $token->setAttribute(\Api::param('api.auth.attr'), $api_key);

        //$r = \Api::em()->getRepository(UsersAuthToken::class)->findOneByToken($api_key);

        $this->session->setExpiresAt((new DateTime())->add(new DateInterval('PT60M')));
        $this->session->setSysAdmin();
        \Api::em()->flush();
    }
